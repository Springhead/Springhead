...
また，これらを統合する
-	 \c Springhead \c Framework　⇒　 \ref pageFramework

があります．一通りの機能をSpringheadに任せたいユーザにとっては，
Frameworkを使用することが最適の選択になるでしょう．
...
\section secFramework フレームワークSDK
\par
\ref pageFramework は，Physics，Graphics，FileIOの3モジュールを統合します．
Frameworkを使うと，ファイルからのロードやセーブ，物理シミュレーション結果の描画用シーングラフへの
反映といった作業が自動化されます．
ユーザはFrameworkが提供するアプリケーションクラスを継承することによって独自の機能を実装することが
できます．
<br><br><br><br>
