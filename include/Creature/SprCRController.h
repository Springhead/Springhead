...
struct CRWalkingControllerDesc : public CRControllerDesc{
	...
	CRWalkingControllerDesc(){
	    ...
	    MaxRoLandingSiteSide = 3.14 / 3.0; 
	    MaxRoLandingSiteBack = 3.14 / 2.5; 
		MaxRoConstraint = 3.14 / 2.2; 
		MaxFootSpeedFront = 25.0;    
	    MaxFootSpeedSide = 15.0;
	    MaxFootSpeedBack = 20.0;  
	    MaxFootAccelerationFront = 30.0;  
	    MaxFootAccelerationSide = 20.0;
	    MaxFootAccelerationBack = 25.0; 
