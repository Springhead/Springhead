...
public: \
	virtual void SetDesc(const void* desc){ \
		...
		abdomenHeight = ((CRHingeAnimalBodyDesc*)desc)->abdomenHeight; \
		abdomenBreadth = ((CRHingeAnimalBodyDesc*)desc)->abdomenBreadth; \
		abdomenThickness = ((CRHingeAnimalBodyDesc*)desc)->abdomenThickness; \
		...
		frontUpperLegLength = ((CRHingeAnimalBodyDesc*)desc)->frontUpperLegLength; \
		frontUpperLegDiameter = ((CRHingeAnimalBodyDesc*)desc)->frontUpperLegDiameter; \
		frontLowerLegLength = ((CRHingeAnimalBodyDesc*)desc)->frontLowerLegLength; \
		frontLowerLegDiameter = ((CRHingeAnimalBodyDesc*)desc)->frontLowerLegDiameter; \
		frontFootLength = ((CRHingeAnimalBodyDesc*)desc)->frontFootLength; \
		frontFootBreadth = ((CRHingeAnimalBodyDesc*)desc)->frontFootBreadth; \
		frontFootThickness = ((CRHingeAnimalBodyDesc*)desc)->frontFootThickness; \
		rearUpperLegLength = ((CRHingeAnimalBodyDesc*)desc)->rearUpperLegLength; \
		rearUpperLegDiameter = ((CRHingeAnimalBodyDesc*)desc)->rearUpperLegDiameter; \
		rearInterLegDistance = ((CRHingeAnimalBodyDesc*)desc)->rearInterLegDistance; \
		rearLowerLegLength = ((CRHingeAnimalBodyDesc*)desc)->rearLowerLegLength; \
		rearLowerLegDiameter = ((CRHingeAnimalBodyDesc*)desc)->rearLowerLegDiameter; \
		rearFootLength = ((CRHingeAnimalBodyDesc*)desc)->rearFootLength; \
		rearFootBreadth = ((CRHingeAnimalBodyDesc*)desc)->rearFootBreadth; \
		rearFootThickness = ((CRHingeAnimalBodyDesc*)desc)->rearFootThickness; \
		rearAnkleToeDistance = ((CRHingeAnimalBodyDesc*)desc)->rearAnkleToeDistance; \
		vertexToEyeHeight = ((CRHingeAnimalBodyDesc*)desc)->vertexToEyeHeight; \
		occiputToEyeDistance = ((CRHingeAnimalBodyDesc*)desc)->occiputToEyeDistance; \
		eyeDiameter = ((CRHingeAnimalBodyDesc*)desc)->eyeDiameter; \
		interpupillaryBreadth = ((CRHingeAnimalBodyDesc*)desc)->interpupillaryBreadth; \
		springWaistAbdomen = ((CRHingeAnimalBodyDesc*)desc)->springWaistAbdomen; \
		damperWaistAbdomen = ((CRHingeAnimalBodyDesc*)desc)->damperWaistAbdomen; \
		springAbdomenChest = ((CRHingeAnimalBodyDesc*)desc)->springAbdomenChest; \
		damperAbdomenChest = ((CRHingeAnimalBodyDesc*)desc)->damperAbdomenChest; \
		springChestNeckX = ((CRHingeAnimalBodyDesc*)desc)->springChestNeckX; \
		damperChestNeckX = ((CRHingeAnimalBodyDesc*)desc)->damperChestNeckX; \
		springChestNeckY = ((CRHingeAnimalBodyDesc*)desc)->springChestNeckY; \
		damperChestNeckY = ((CRHingeAnimalBodyDesc*)desc)->damperChestNeckY; \
		springChestNeckZ = ((CRHingeAnimalBodyDesc*)desc)->springChestNeckZ; \
		damperChestNeckZ = ((CRHingeAnimalBodyDesc*)desc)->damperChestNeckZ; \
		springNeckHeadX = ((CRHingeAnimalBodyDesc*)desc)->springNeckHeadX; \
		...
		damperShoulderX = ((CRHingeAnimalBodyDesc*)desc)->damperShoulderX; \
		springShoulderY = ((CRHingeAnimalBodyDesc*)desc)->springShoulderY; \
		damperShoulderY = ((CRHingeAnimalBodyDesc*)desc)->damperShoulderY; \
		springElbow = ((CRHingeAnimalBodyDesc*)desc)->springElbow; \
		damperElbow = ((CRHingeAnimalBodyDesc*)desc)->damperElbow; \
		springFrontAnkleY = ((CRHingeAnimalBodyDesc*)desc)->springFrontAnkleY; \
		damperFrontAnkleY = ((CRHingeAnimalBodyDesc*)desc)->damperFrontAnkleY; \
		springFrontAnkleX = ((CRHingeAnimalBodyDesc*)desc)->springFrontAnkleX; \
		damperFrontAnkleX = ((CRHingeAnimalBodyDesc*)desc)->damperFrontAnkleX; \
		springFrontAnkleZ = ((CRHingeAnimalBodyDesc*)desc)->springFrontAnkleZ; \
		damperFrontAnkleZ = ((CRHingeAnimalBodyDesc*)desc)->damperFrontAnkleZ; \
		springWaistLegZ = ((CRHingeAnimalBodyDesc*)desc)->springWaistLegZ; \
		damperWaistLegZ = ((CRHingeAnimalBodyDesc*)desc)->damperWaistLegZ; \
		springWaistLegX = ((CRHingeAnimalBodyDesc*)desc)->springWaistLegX; \
		damperWaistLegX = ((CRHingeAnimalBodyDesc*)desc)->damperWaistLegX; \
		springWaistLegY = ((CRHingeAnimalBodyDesc*)desc)->springWaistLegY; \
		damperWaistLegY = ((CRHingeAnimalBodyDesc*)desc)->damperWaistLegY; \
		springKnee = ((CRHingeAnimalBodyDesc*)desc)->springKnee; \
		damperKnee = ((CRHingeAnimalBodyDesc*)desc)->damperKnee; \
		springRearAnkleY = ((CRHingeAnimalBodyDesc*)desc)->springRearAnkleY; \
		damperRearAnkleY = ((CRHingeAnimalBodyDesc*)desc)->damperRearAnkleY; \
		springRearAnkleX = ((CRHingeAnimalBodyDesc*)desc)->springRearAnkleX; \
		damperRearAnkleX = ((CRHingeAnimalBodyDesc*)desc)->damperRearAnkleX; \
		springRearAnkleZ = ((CRHingeAnimalBodyDesc*)desc)->springRearAnkleZ; \
		damperRearAnkleZ = ((CRHingeAnimalBodyDesc*)desc)->damperRearAnkleZ; \
		springEyeY = ((CRHingeAnimalBodyDesc*)desc)->springEyeY; \
		damperEyeY = ((CRHingeAnimalBodyDesc*)desc)->damperEyeY; \
		springEyeX = ((CRHingeAnimalBodyDesc*)desc)->springEyeX; \
		damperEyeX = ((CRHingeAnimalBodyDesc*)desc)->damperEyeX; \
		posRightFrontUpperLeg = ((CRHingeAnimalBodyDesc*)desc)->posRightFrontUpperLeg; \
		oriRightFrontUpperLeg = ((CRHingeAnimalBodyDesc*)desc)->oriRightFrontUpperLeg; \
		oriRightFrontLowerLeg = ((CRHingeAnimalBodyDesc*)desc)->oriRightFrontLowerLeg; \
		oriRightFrontFoot = ((CRHingeAnimalBodyDesc*)desc)->oriRightFrontFoot; \
		rangeWaistAbdomen = ((CRHingeAnimalBodyDesc*)desc)->rangeWaistAbdomen; \
		rangeAbdomenChest = ((CRHingeAnimalBodyDesc*)desc)->rangeAbdomenChest; \
		rangeChestNeckX = ((CRHingeAnimalBodyDesc*)desc)->rangeChestNeckX; \
		rangeChestNeckY = ((CRHingeAnimalBodyDesc*)desc)->rangeChestNeckY; \
		...
		rangeFrontAnkleY = ((CRHingeAnimalBodyDesc*)desc)->rangeFrontAnkleY; \
		rangeFrontAnkleX = ((CRHingeAnimalBodyDesc*)desc)->rangeFrontAnkleX; \
		rangeFrontAnkleZ = ((CRHingeAnimalBodyDesc*)desc)->rangeFrontAnkleZ; \
		rangeWaistLegZ = ((CRHingeAnimalBodyDesc*)desc)->rangeWaistLegZ; \
		rangeWaistLegX = ((CRHingeAnimalBodyDesc*)desc)->rangeWaistLegX; \
		rangeWaistLegY = ((CRHingeAnimalBodyDesc*)desc)->rangeWaistLegY; \
		rangeKnee = ((CRHingeAnimalBodyDesc*)desc)->rangeKnee; \
		rangeRearAnkleY = ((CRHingeAnimalBodyDesc*)desc)->rangeRearAnkleY; \
		rangeRearAnkleX = ((CRHingeAnimalBodyDesc*)desc)->rangeRearAnkleX; \
		rangeRearAnkleZ = ((CRHingeAnimalBodyDesc*)desc)->rangeRearAnkleZ; \
		rangeRightEyeY = ((CRHingeAnimalBodyDesc*)desc)->rangeRightEyeY; \
		rangeEyeX = ((CRHingeAnimalBodyDesc*)desc)->rangeEyeX; \
	...
	virtual bool GetDesc(void* desc){ \
		...
		((CRHingeAnimalBodyDesc*)desc)->abdomenHeight = abdomenHeight; \
		((CRHingeAnimalBodyDesc*)desc)->abdomenBreadth = abdomenBreadth; \
		((CRHingeAnimalBodyDesc*)desc)->abdomenThickness = abdomenThickness; \
		...
		((CRHingeAnimalBodyDesc*)desc)->frontUpperLegLength = frontUpperLegLength; \
		((CRHingeAnimalBodyDesc*)desc)->frontUpperLegDiameter = frontUpperLegDiameter; \
		((CRHingeAnimalBodyDesc*)desc)->frontLowerLegLength = frontLowerLegLength; \
		((CRHingeAnimalBodyDesc*)desc)->frontLowerLegDiameter = frontLowerLegDiameter; \
		((CRHingeAnimalBodyDesc*)desc)->frontFootLength = frontFootLength; \
		((CRHingeAnimalBodyDesc*)desc)->frontFootBreadth = frontFootBreadth; \
		((CRHingeAnimalBodyDesc*)desc)->frontFootThickness = frontFootThickness; \
		((CRHingeAnimalBodyDesc*)desc)->rearUpperLegLength = rearUpperLegLength; \
		((CRHingeAnimalBodyDesc*)desc)->rearUpperLegDiameter = rearUpperLegDiameter; \
		((CRHingeAnimalBodyDesc*)desc)->rearInterLegDistance = rearInterLegDistance; \
		((CRHingeAnimalBodyDesc*)desc)->rearLowerLegLength = rearLowerLegLength; \
		((CRHingeAnimalBodyDesc*)desc)->rearLowerLegDiameter = rearLowerLegDiameter; \
		((CRHingeAnimalBodyDesc*)desc)->rearFootLength = rearFootLength; \
		((CRHingeAnimalBodyDesc*)desc)->rearFootBreadth = rearFootBreadth; \
		((CRHingeAnimalBodyDesc*)desc)->rearFootThickness = rearFootThickness; \
		((CRHingeAnimalBodyDesc*)desc)->rearAnkleToeDistance = rearAnkleToeDistance; \
		((CRHingeAnimalBodyDesc*)desc)->vertexToEyeHeight = vertexToEyeHeight; \
		((CRHingeAnimalBodyDesc*)desc)->occiputToEyeDistance = occiputToEyeDistance; \
		((CRHingeAnimalBodyDesc*)desc)->eyeDiameter = eyeDiameter; \
		((CRHingeAnimalBodyDesc*)desc)->interpupillaryBreadth = interpupillaryBreadth; \
		((CRHingeAnimalBodyDesc*)desc)->springWaistAbdomen = springWaistAbdomen; \
		((CRHingeAnimalBodyDesc*)desc)->damperWaistAbdomen = damperWaistAbdomen; \
		((CRHingeAnimalBodyDesc*)desc)->springAbdomenChest = springAbdomenChest; \
		((CRHingeAnimalBodyDesc*)desc)->damperAbdomenChest = damperAbdomenChest; \
		((CRHingeAnimalBodyDesc*)desc)->springChestNeckX = springChestNeckX; \
		((CRHingeAnimalBodyDesc*)desc)->damperChestNeckX = damperChestNeckX; \
		((CRHingeAnimalBodyDesc*)desc)->springChestNeckY = springChestNeckY; \
		((CRHingeAnimalBodyDesc*)desc)->damperChestNeckY = damperChestNeckY; \
		((CRHingeAnimalBodyDesc*)desc)->springChestNeckZ = springChestNeckZ; \
		((CRHingeAnimalBodyDesc*)desc)->damperChestNeckZ = damperChestNeckZ; \
		((CRHingeAnimalBodyDesc*)desc)->springNeckHeadX = springNeckHeadX; \
		...
		((CRHingeAnimalBodyDesc*)desc)->damperShoulderX = damperShoulderX; \
		((CRHingeAnimalBodyDesc*)desc)->springShoulderY = springShoulderY; \
		((CRHingeAnimalBodyDesc*)desc)->damperShoulderY = damperShoulderY; \
		((CRHingeAnimalBodyDesc*)desc)->springElbow = springElbow; \
		((CRHingeAnimalBodyDesc*)desc)->damperElbow = damperElbow; \
		((CRHingeAnimalBodyDesc*)desc)->springFrontAnkleY = springFrontAnkleY; \
		((CRHingeAnimalBodyDesc*)desc)->damperFrontAnkleY = damperFrontAnkleY; \
		((CRHingeAnimalBodyDesc*)desc)->springFrontAnkleX = springFrontAnkleX; \
		((CRHingeAnimalBodyDesc*)desc)->damperFrontAnkleX = damperFrontAnkleX; \
		((CRHingeAnimalBodyDesc*)desc)->springFrontAnkleZ = springFrontAnkleZ; \
		((CRHingeAnimalBodyDesc*)desc)->damperFrontAnkleZ = damperFrontAnkleZ; \
		((CRHingeAnimalBodyDesc*)desc)->springWaistLegZ = springWaistLegZ; \
		((CRHingeAnimalBodyDesc*)desc)->damperWaistLegZ = damperWaistLegZ; \
		((CRHingeAnimalBodyDesc*)desc)->springWaistLegX = springWaistLegX; \
		((CRHingeAnimalBodyDesc*)desc)->damperWaistLegX = damperWaistLegX; \
		((CRHingeAnimalBodyDesc*)desc)->springWaistLegY = springWaistLegY; \
		((CRHingeAnimalBodyDesc*)desc)->damperWaistLegY = damperWaistLegY; \
		((CRHingeAnimalBodyDesc*)desc)->springKnee = springKnee; \
		((CRHingeAnimalBodyDesc*)desc)->damperKnee = damperKnee; \
		((CRHingeAnimalBodyDesc*)desc)->springRearAnkleY = springRearAnkleY; \
		((CRHingeAnimalBodyDesc*)desc)->damperRearAnkleY = damperRearAnkleY; \
		((CRHingeAnimalBodyDesc*)desc)->springRearAnkleX = springRearAnkleX; \
		((CRHingeAnimalBodyDesc*)desc)->damperRearAnkleX = damperRearAnkleX; \
		((CRHingeAnimalBodyDesc*)desc)->springRearAnkleZ = springRearAnkleZ; \
		((CRHingeAnimalBodyDesc*)desc)->damperRearAnkleZ = damperRearAnkleZ; \
		((CRHingeAnimalBodyDesc*)desc)->springEyeY = springEyeY; \
		((CRHingeAnimalBodyDesc*)desc)->damperEyeY = damperEyeY; \
		((CRHingeAnimalBodyDesc*)desc)->springEyeX = springEyeX; \
		((CRHingeAnimalBodyDesc*)desc)->damperEyeX = damperEyeX; \
		((CRHingeAnimalBodyDesc*)desc)->posRightFrontUpperLeg = posRightFrontUpperLeg; \
		((CRHingeAnimalBodyDesc*)desc)->oriRightFrontUpperLeg = oriRightFrontUpperLeg; \
		((CRHingeAnimalBodyDesc*)desc)->oriRightFrontLowerLeg = oriRightFrontLowerLeg; \
		((CRHingeAnimalBodyDesc*)desc)->oriRightFrontFoot = oriRightFrontFoot; \
		((CRHingeAnimalBodyDesc*)desc)->rangeWaistAbdomen = rangeWaistAbdomen; \
		((CRHingeAnimalBodyDesc*)desc)->rangeAbdomenChest = rangeAbdomenChest; \
		((CRHingeAnimalBodyDesc*)desc)->rangeChestNeckX = rangeChestNeckX; \
		((CRHingeAnimalBodyDesc*)desc)->rangeChestNeckY = rangeChestNeckY; \
		...
		((CRHingeAnimalBodyDesc*)desc)->rangeFrontAnkleY = rangeFrontAnkleY; \
		((CRHingeAnimalBodyDesc*)desc)->rangeFrontAnkleX = rangeFrontAnkleX; \
		((CRHingeAnimalBodyDesc*)desc)->rangeFrontAnkleZ = rangeFrontAnkleZ; \
		((CRHingeAnimalBodyDesc*)desc)->rangeWaistLegZ = rangeWaistLegZ; \
		((CRHingeAnimalBodyDesc*)desc)->rangeWaistLegX = rangeWaistLegX; \
		((CRHingeAnimalBodyDesc*)desc)->rangeWaistLegY = rangeWaistLegY; \
		((CRHingeAnimalBodyDesc*)desc)->rangeKnee = rangeKnee; \
		((CRHingeAnimalBodyDesc*)desc)->rangeRearAnkleY = rangeRearAnkleY; \
		((CRHingeAnimalBodyDesc*)desc)->rangeRearAnkleX = rangeRearAnkleX; \
		((CRHingeAnimalBodyDesc*)desc)->rangeRearAnkleZ = rangeRearAnkleZ; \
		((CRHingeAnimalBodyDesc*)desc)->rangeRightEyeY = rangeRightEyeY; \
		((CRHingeAnimalBodyDesc*)desc)->rangeEyeX = rangeEyeX; \
