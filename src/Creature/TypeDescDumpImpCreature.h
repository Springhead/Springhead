//	Do not edit. MakeTypeDesc.bat will update this file.
	...
	field = desc->AddField("", "double", "springTailWaist", "");
	...
	field = desc->AddField("", "double", "springChestNeckXY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springChestNeckXY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperChestNeckXY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperChestNeckXY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springChestNeckYZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springChestNeckYZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperChestNeckYZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperChestNeckYZ) - (char*)pCRHingeAnimalBodyDesc);
	...
	field = desc->AddField("", "double", "springShoulder_X", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springShoulder_X) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperShoulder_X", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperShoulder_X) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springShoulder_Y", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springShoulder_Y) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperShoulder_Y", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperShoulder_Y) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springShoulder_Z", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springShoulder_Z) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperShoulder_Z", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperShoulder_Z) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springElbow", "");
	...
	field = desc->AddField("", "double", "springFrontAnkle_X", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springFrontAnkle_X) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperFrontAnkle_X", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperFrontAnkle_X) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springFrontAnkle_Y", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springFrontAnkle_Y) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperFrontAnkle_Y", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperFrontAnkle_Y) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springFrontAnkle_Z", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springFrontAnkle_Z) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperFrontAnkle_Z", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperFrontAnkle_Z) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springHip_X", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springHip_X) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperHip_X", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperHip_X) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springHip_Y", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springHip_Y) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperHip_Y", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperHip_Y) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springHip_Z", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springHip_Z) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperHip_Z", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperHip_Z) - (char*)pCRHingeAnimalBodyDesc);
	...
	field = desc->AddField("", "double", "springRearAnkle_X", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springRearAnkle_X) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperRearAnkle_X", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperRearAnkle_X) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springRearAnkle_Y", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springRearAnkle_Y) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperRearAnkle_Y", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperRearAnkle_Y) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springRearAnkle_Z", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springRearAnkle_Z) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperRearAnkle_Z", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperRearAnkle_Z) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeChestNeckXY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeChestNeckXY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeChestNeckYZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeChestNeckYZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeChestNeck", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeChestNeck) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeNeckHead", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeNeckHead) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeShoulder_X", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeShoulder_X) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeShoulder_Y", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeShoulder_Y) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeShoulder_Z", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeShoulder_Z) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeElbow", "");
	...
	field = desc->AddField("", "Vec2d", "rangeFrontAnkle_X", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeFrontAnkle_X) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeFrontAnkle_Y", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeFrontAnkle_Y) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeFrontAnkle_Z", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeFrontAnkle_Z) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeHip_X", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeHip_X) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeHip_Y", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeHip_Y) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeHip_Z", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeHip_Z) - (char*)pCRHingeAnimalBodyDesc);
	...
	field = desc->AddField("", "Vec2d", "rangeRearAnkle_X", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeRearAnkle_X) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeRearAnkle_Y", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeRearAnkle_Y) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeRearAnkle_Z", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeRearAnkle_Z) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Quaterniond", "oriTailWaist", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->oriTailWaist) - (char*)pCRHingeAnimalBodyDesc);
