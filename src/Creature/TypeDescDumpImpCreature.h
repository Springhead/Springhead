//	Do not edit. MakeTypeDesc.bat will update this file.
	...
	field = desc->AddField("", "double", "abdomenHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->abdomenHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "abdomenBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->abdomenBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "abdomenThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->abdomenThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "chestHeight", "");
	...
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tail1Height) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "tail1Breath", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tail1Breath) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "tail1Thickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tail1Thickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "tail2Height", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tail2Height) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "tail2Breath", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tail2Breath) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "tail2Thickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tail2Thickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "tail3Height", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tail3Height) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "tail3Breath", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tail3Breath) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "tail3Thickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tail3Thickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "neckLength", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->neckLength) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "neckDiameter", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->neckDiameter) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "headDiameter", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->headDiameter) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "frontUpperLegLength", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->frontUpperLegLength) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "frontUpperLegDiameter", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->frontUpperLegDiameter) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "frontLowerLegLength", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->frontLowerLegLength) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "frontLowerLegDiameter", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->frontLowerLegDiameter) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "frontFootLength", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->frontFootLength) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "frontFootBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->frontFootBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "frontFootThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->frontFootThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "rearUpperLegLength", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rearUpperLegLength) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "rearUpperLegDiameter", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rearUpperLegDiameter) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "rearInterLegDistance", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rearInterLegDistance) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "rearLowerLegLength", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rearLowerLegLength) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "rearLowerLegDiameter", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rearLowerLegDiameter) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "rearFootLength", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rearFootLength) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "rearFootBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rearFootBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "rearFootThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rearFootThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "rearAnkleToeDistance", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rearAnkleToeDistance) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "vertexToEyeHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->vertexToEyeHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "occiputToEyeDistance", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->occiputToEyeDistance) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "eyeDiameter", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->eyeDiameter) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "interpupillaryBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->interpupillaryBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springWaistAbdomen", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springWaistAbdomen) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperWaistAbdomen", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperWaistAbdomen) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springAbdomenChest", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springAbdomenChest) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperAbdomenChest", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperAbdomenChest) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springChestNeckX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springChestNeckX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperChestNeckX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperChestNeckX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springChestNeckY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springChestNeckY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperChestNeckY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperChestNeckY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springChestNeckZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springChestNeckZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperChestNeckZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperChestNeckZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springNeckHeadX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springNeckHeadX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperNeckHeadX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperNeckHeadX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springNeckHeadZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springNeckHeadZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperNeckHeadZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperNeckHeadZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springShoulderZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springShoulderZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperShoulderZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperShoulderZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springShoulderX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springShoulderX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperShoulderX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperShoulderX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springShoulderY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springShoulderY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperShoulderY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperShoulderY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springElbow", "");
	...
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springFrontAnkleY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperFrontAnkleY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperFrontAnkleY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springFrontAnkleX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springFrontAnkleX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperFrontAnkleX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperFrontAnkleX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springFrontAnkleZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springFrontAnkleZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperFrontAnkleZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperFrontAnkleZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springWaistLegZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springWaistLegZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperWaistLegZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperWaistLegZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springWaistLegX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springWaistLegX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperWaistLegX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperWaistLegX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springWaistLegY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springWaistLegY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperWaistLegY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperWaistLegY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springKnee", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springKnee) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperKnee", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperKnee) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springRearAnkleY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springRearAnkleY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperRearAnkleY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperRearAnkleY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springRearAnkleX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springRearAnkleX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperRearAnkleX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperRearAnkleX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springRearAnkleZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springRearAnkleZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperRearAnkleZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperRearAnkleZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springEyeY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springEyeY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperEyeY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperEyeY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "springEyeX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->springEyeX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "double", "damperEyeX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->damperEyeX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec3d", "posRightFrontUpperLeg", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->posRightFrontUpperLeg) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Quaterniond", "oriRightFrontUpperLeg", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->oriRightFrontUpperLeg) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Quaterniond", "oriRightFrontLowerLeg", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->oriRightFrontLowerLeg) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Quaterniond", "oriRightFrontFoot", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->oriRightFrontFoot) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeWaistAbdomen", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeWaistAbdomen) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeAbdomenChest", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeAbdomenChest) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeChestNeckX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeChestNeckX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeChestNeckY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeChestNeckY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeChestNeckZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeChestNeckZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeNeckHeadX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeNeckHeadX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeNeckHeadZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeNeckHeadZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeShoulderZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeShoulderZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeShoulderX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeShoulderX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeShoulderY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeShoulderY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeElbow", "");
	...
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeFrontAnkleY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeFrontAnkleX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeFrontAnkleX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeFrontAnkleZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeFrontAnkleZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeWaistLegZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeWaistLegZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeWaistLegX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeWaistLegX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeWaistLegY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeWaistLegY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeKnee", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeKnee) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeRearAnkleY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeRearAnkleY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeRearAnkleX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeRearAnkleX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeRearAnkleZ", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeRearAnkleZ) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeRightEyeY", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeRightEyeY) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeEyeX", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeEyeX) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "bool", "noLegs", "");
