//	Do not edit. MakeTypeDesc.bat will update this file.
	...
	field = desc->AddField("", "Vec2d", "rangeTwistShoulder", "");
	...
	field = desc->AddField("", "Vec2d", "rangeTwistRearAnkle", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rangeTwistRearAnkle) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "bool", "noLegs", "");
