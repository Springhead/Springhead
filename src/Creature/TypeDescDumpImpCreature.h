//	Do not edit. MakeTypeDesc.bat will update this file.
	...
	field = desc->AddField("", "float", "waistBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->waistBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "waistHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->waistHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "waistThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->waistThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "chestBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->chestBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "chestHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->chestHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "chestThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->chestThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "tailBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tailBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "tailHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tailHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "tailThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tailThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "neckBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->neckBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "neckHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->neckHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "neckThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->neckThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "headBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->headBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "headHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->headHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "headThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->headThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "breastboneBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->breastboneBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "breastboneHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->breastboneHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "breastboneThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->breastboneThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "radiusBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->radiusBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "radiusHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->radiusHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "radiusThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->radiusThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "frontCannonBoneBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->frontCannonBoneBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "frontCannonBoneHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->frontCannonBoneHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "frontCannonBoneThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->frontCannonBoneThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "frontToeBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->frontToeBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "frontToeHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->frontToeHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "frontToeThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->frontToeThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "femurBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->femurBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "femurHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->femurHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "femurThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->femurThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "tibiaBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tibiaBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "tibiaHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tibiaHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "tibiaThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->tibiaThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "rearCannonBoneBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rearCannonBoneBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "rearCannonBoneHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rearCannonBoneHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "rearCannonBoneThickness", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rearCannonBoneThickness) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "rearToeBreadth", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rearToeBreadth) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "rearToeHeight", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->rearToeHeight) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "float", "rearToeThickness", "");
	...
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->goalWaistChest) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Quaterniond", "goalWaistTail", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->goalWaistTail) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Quaterniond", "goalTail", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->goalTail) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Quaterniond", "goalChestNeck", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->goalChestNeck) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Quaterniond", "goalNeckHead", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->goalNeckHead) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Quaterniond", "goalShoulder", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->goalShoulder) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Quaterniond", "goalFrontAnkle", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->goalFrontAnkle) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Quaterniond", "goalHip", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->goalHip) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Quaterniond", "goalRearAnkle", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->goalRearAnkle) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec3d", "limitDirWaistChest", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->limitDirWaistChest) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec3d", "limitDirWaistTail", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->limitDirWaistTail) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec3d", "limitDirTail", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->limitDirTail) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec3d", "limitDirChestNeck", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->limitDirChestNeck) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec3d", "limitDirNeckHead", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->limitDirNeckHead) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec3d", "limitDirShoulder", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->limitDirShoulder) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec3d", "limitDirFrontAnkle", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->limitDirFrontAnkle) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec3d", "limitDirHip", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->limitDirHip) - (char*)pCRHingeAnimalBodyDesc);
	field = desc->AddField("", "Vec3d", "limitDirRearAnkle", "");
	field->offset = int((char*)&(pCRHingeAnimalBodyDesc->limitDirRearAnkle) - (char*)pCRHingeAnimalBodyDesc);
