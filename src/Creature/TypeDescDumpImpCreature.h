//	Do not edit. MakeTypeDesc.bat will update this file.
	...
	field = desc->AddField("", "double", "upperArmLength", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->upperArmLength) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "upperArmDiameter", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->upperArmDiameter) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "lowerArmLength", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->lowerArmLength) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "lowerArmDiameter", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->lowerArmDiameter) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "handLength", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->handLength) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "handBreadth", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->handBreadth) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "handThickness", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->handThickness) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "upperLegLength", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->upperLegLength) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "upperLegDiameter", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->upperLegDiameter) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "interLegDistance", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->interLegDistance) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "lowerLegLength", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->lowerLegLength) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "lowerLegDiameter", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->lowerLegDiameter) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "footLength", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->footLength) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "footBreadth", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->footBreadth) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "footThickness", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->footThickness) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "ankleToeDistance", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->ankleToeDistance) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "vertexToEyeHeight", "");
	...
	field = desc->AddField("", "double", "springWristY", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->springWristY) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "damperWristY", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->damperWristY) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "springWristX", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->springWristX) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "damperWristX", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->damperWristX) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "springWristZ", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->springWristZ) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "damperWristZ", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->damperWristZ) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "springWaistLegZ", "");
	...
	field = desc->AddField("", "double", "springAnkleY", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->springAnkleY) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "damperAnkleY", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->damperAnkleY) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "springAnkleX", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->springAnkleX) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "damperAnkleX", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->damperAnkleX) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "springAnkleZ", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->springAnkleZ) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "damperAnkleZ", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->damperAnkleZ) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "double", "springEyeY", "");
	...
	field = desc->AddField("", "Vec3d", "posRightUpperArm", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->posRightUpperArm) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "Quaterniond", "oriRightUpperArm", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->oriRightUpperArm) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "Quaterniond", "oriRightLowerArm", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->oriRightLowerArm) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "Quaterniond", "oriRightHand", "");
	...
	field = desc->AddField("", "Vec2d", "rangeWristY", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->rangeWristY) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeWristX", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->rangeWristX) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeWristZ", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->rangeWristZ) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeWaistLegZ", "");
	...
	field = desc->AddField("", "Vec2d", "rangeAnkleY", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->rangeAnkleY) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeAnkleX", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->rangeAnkleX) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeAnkleZ", "");
	field->offset = int((char*)&(pCRHingeMammalBodyDesc->rangeAnkleZ) - (char*)pCRHingeMammalBodyDesc);
	field = desc->AddField("", "Vec2d", "rangeRightEyeY", "");
