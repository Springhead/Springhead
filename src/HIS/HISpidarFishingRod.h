#ifndef HDSPIDARFISHINGROD_H
#define HDSPIDARFISHINGROD_H
...
class SPR_DLL HISpidarFishingRod: public HIForceDevice3D,public HISpidarCalc3Dof{
public:
	std::vector<HISpidarMotor> motor;	///<	モータ
	std::vector<DVPioBase*> button;	///<	ボタン

		///	デバイスのタイプ
	HIOBJECTDEF(HISpidarFishingRod);
...
//	Vec3f GetTorque(){ return rotForce; }
	...
	/// ボタン情報の取得
	int HISpidarFishingRod::GetButton(int ch){
...
/*
class SPR_DLL HISpidarFishingRod: public HISpidarG6{
public:
	///	デバイスのタイプ
	HIOBJECTDEF(HISpidarFishingRod);
