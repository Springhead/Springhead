...
rem echo EXTEND_N_GET_TO_LIST(Spr::CRBoneIf	,NContacts		,GetContactForce	,Vec3f			)>>%MODULE%.i  RuntimeDownCastができない
rem echo EXTEND_N_GET_TO_LIST(Spr::CRBoneIf	,NContacts		,GetContactArea		,double			)>>%MODULE%.i newEPdoubleになってしまう
rem echo EXTEND_N_GET_TO_LIST(Spr::CRBoneIf	,NContacts		,GetContactPosition	,Vec3f			)>>%MODULE%.i  RuntimeDownCastができない
