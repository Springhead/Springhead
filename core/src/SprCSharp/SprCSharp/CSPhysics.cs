	...
	public void Step() {
            ...
            if (phSceneIf.threadMode) {
                ...
                lock (phSceneIf.waitUntilNextStepCallbackDictionaryLock) { 
                    phSceneIf.ExecWaitUntilNextStepCallbackList(nextStepPHScene); // NotnextStepPHSceneÇåƒÇ‘Ç∆Save/Loadå„Ç…åƒÇŒÇÍÇÈÇ◊Ç´CallbackÇ™êÊÇ…é¿çsÇ≥ÇÍÇƒÇµÇ‹Ç§
                }
                ...
                //Ç±Ç±Ç…nextStepPHSceneÇÃwaitUntilÇ™ïKóvÇ©
                lock (phSceneIf.waitUntilNextStepCallbackDictionaryLock) { // Ç±Ç±ÇÃä‘Ç…Callbackí«â¡Ç≥ÇÍÇÈÇ∆Save/Loadå„Ç…åƒÇŒÇÍÇÈÇ◊Ç´CallbackÇ™êÊÇ…é¿çsÇ≥ÇÍÇƒÇµÇ‹Ç§â¬î\ê´Ç™Ç†ÇÈ
