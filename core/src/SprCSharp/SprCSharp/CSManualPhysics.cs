...
namespace SprCs {
    public partial class PHSdkIf : SdkIf {
        ...
        public PHSceneIf CreateScene(PHSceneDesc desc, bool multiThreadMode = false) {
            if (multiThreadMode) {
                ...
                //IntPtr ptr1 = SprExport.Spr_PHSdkIf_CreateScene((IntPtr)this, (IntPtr)desc);
                //if (ptr1 == IntPtr.Zero) {
                //    Console.WriteLine("Create Scene null");
                //    return null;
                //}
    ...
    public partial class PHSceneIf : SceneIf {
        ...
        public void Swap() {
            Console.WriteLine("Swapの実装がない ");
        }
        public void SwapAfterSubThreadOneExecution() {
            Console.WriteLine("SwapAfterSubThreadOneExecutionの実装がない ");
        }
