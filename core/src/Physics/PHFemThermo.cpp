...
PHFemThermo::PHFemThermo(const PHFemThermoDesc& desc, SceneIf* s){
	...
	epsilonG = 1.0;
	//%%%	初期条件
	jout = 24.5;//22.0;	//A5052熱伝達実験時:22.9, SUS430放熱実験時:29.9	//(48.0+30.0)/2.0;		// 150:77.85, 200:94.25, 100:58.7
	//Setems(3.58e-2);
	//ems =3.58e-2;//0.0;//3.8e-2;//3.63e-2;//3.58		//	節点での熱輻射係数：温度の差分に比例する値なので、3.58e-2	SUS430での値
	ems_const = -1.14;//-1.1507//-1.063;
	temp_c = 24.5;//30.0;
	temp_out =  26;//26.8;//20.0;//23.8;	//A5052試料時室温:23.8, SUS430放熱実験時:29.9
